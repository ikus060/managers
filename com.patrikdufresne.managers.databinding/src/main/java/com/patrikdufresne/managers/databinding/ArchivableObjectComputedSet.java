...
public class ArchivableObjectComputedSet extends ManagedObjectComputedSet {
     ...
     *            the element type
     */
    public ArchivableObjectComputedSet(Managers managers, Class<? extends ArchivableObject> elementType, int mode) {
     ...
     */
    public ArchivableObjectComputedSet(Managers managers, Class<? extends ArchivableObject> elementType, IObservable[] dependencies, int mode) {
     ...
     */
    public ArchivableObjectComputedSet(Managers managers, Class<? extends ArchivableObject> elementType, Map<Class, Integer> events, int mode) {
     ...
     */
    public ArchivableObjectComputedSet(
            Managers managers,
    ...
    protected boolean doSelect(Object element) {
        return element instanceof ArchivableObject && ((ArchivableObject) element).getArchivedDate() == null
                ? this.mode == MODE_NOT_ARCHIVED
