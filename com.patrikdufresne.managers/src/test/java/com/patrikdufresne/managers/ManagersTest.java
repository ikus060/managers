...
public class ManagersTest extends AbstractManagerTest {
    ...
    public void testAdd_withNewEntity_ExpectEvent() throws ManagerException {
        ...
        getManagers().getMockEntityManager().addObserver(ManagerEvent.ADD, counter);
        ...
        assertEquals((new Date()).getTime(), entity.getCreationDate().getTime(), 60000);
        assertEquals((new Date()).getTime(), entity.getModificationDate().getTime(), 60000);
    ...
    public void testArchive() throws ManagerException {
        ...
        ManagerEventCounter counter = new ManagerEventCounter();
        getManagers().addObserver(ManagerEvent.UPDATE, MockEntity.class, counter);
    ...
    @Test
    public void testFailToBeginTransaction_SessionClosed() throws ManagerException, InterruptedException {
    ...
    public void testObjectIdentity() throws ManagerException {
        ...
        assertEquals("Properties not copied.", entity.getName(), entity2.getName());

    }

    @Test(expected = ManagerException.class)
    public void testQuery_WithSafeQuery_ExpectCallToHandleException() throws ManagerException {
    ...
    public void testRemove_withEntity_ExpectEvent() throws ManagerException {
        ...
        ManagerEventCounter counter = new ManagerEventCounter();
        getManagers().getMockEntityManager().addObserver(ManagerEvent.REMOVE, counter);
     ...
     */
    @Test
    public void testUpdate_withEntity_ExpectEventAndReferenceUpdate() throws ManagerException {
        ...
        ManagerEventCounter counter = new ManagerEventCounter();
        getManagers().getMockEntityManager().addObserver(ManagerEvent.UPDATE, counter);
     ...
     */
    @Test
    public void testUpdate_WithManagerException_SessionClosed() throws ManagerException {
        ...
        entity.setName("b");
        try {
            getManagers().getMockEntityManager().updateWithManagerException(Arrays.asList(entity));
     ...
     */
    @Test
    public void testUpdate_WithManagerExceptionInThread_SessionClosed() throws ManagerException, InterruptedException {
        ...
        entity2.setName("b");
        getManagers().getMockEntityManager().add(Arrays.asList(entity1, entity2));
        assertEquals("Wrong number of entities", 2, getManagers().getMockEntityManager().list().size());
        ...
        (thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    getManagers().getMockEntityManager().addWithManagerException(Arrays.asList(entity2));
                    Assert.fail("An exception should be trown");
                } catch (ManagerException e) {
                    // Nothing to do, this is expected
                } catch (Throwable e) {
     ...
     */
    @Test
    public void testUpdate_WithRuntimeException_SessionClosed() throws ManagerException {
        ...
        entity.setName("b");
        try {
            getManagers().getMockEntityManager().updateWithRuntimeException(Arrays.asList(entity));
            Assert.fail("An exception should be trown");
        } catch (ManagerException e) {
            // Nothing to do, this is expected
